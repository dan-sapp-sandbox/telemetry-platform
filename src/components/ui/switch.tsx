...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    className={cn(
      ...
      "data-[state=checked]:bg-zinc-400/55 data-[state=unchecked]:bg-zinc-400/35",
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-emerald-400/60 shadow-md ring-1 ring-border/40",
