...
export const palletWrapperStyles = cn([
  ...
  "p-2 xl:p-4 h-42 w-1/2 md:h-55 lg:w-80 xl:h-75 xl:w-100",
]);
export const buttonStyles = cn([
  ...
  "w-16 h-16 md:w-16 md:h-16 xl:w-20 xl:h-20",
]);
...
export const backButtonStyles = cn([
  ...
  "group w-8 h-4 lg:w-12 lg:h-10 xl:w-12 xl:h-10 p-px md:p-1",
]);
